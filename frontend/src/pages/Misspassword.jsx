  ...
  return (
    <div className="headerQuiz">
      <div className="LoginUser">
        {msgerror && <p style={{ textAlign: "center" }}>{msgerrortext}</p>}
        <Box className="init">
          <Stepper
          ...
          {activeStep === steps.length ? (
            <React.Fragment>
              ...
              <Box sx={{ display: "flex", flexDirection: "row", pt: 2 }}>
                ...
                <Button className="accept" onClick={handleconnection}>
                  Suivant
                </Button>
              </Box>
            </React.Fragment>
            ...
            <React.Fragment>
              ...
              {activeStep === 1 && (
                <div className="container">
                  <p>Entrer votre numéro de vérification de votre email</p>
                  <input
                    type="text"
        ...
        <div className="linkpath" style={{ marginTop: "20px" }}>
          <p>
